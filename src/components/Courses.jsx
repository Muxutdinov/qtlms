    ...
    return (
        ...
        <div class="container">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="course">
                        ...
                        <div class="course__body">
                            <a href="#">Маркетинг и все его тонкости. Профессия маркетолога с 0 до эксперта</a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="course">
                        ...
                        <div class="course__footer">
                            <div class="price-btn">
                                <strong class="__price">95 000 сум</strong>
                                <button type="button" class="btn btn-light btn-sm" disabled>Выбран</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="btn-container btn-container--center">
                <a href="#" class="btn btn-primary">Смотреть все курсы</a>
            </div>
        </div>
    </section>
        </div>
